...
| 05 | OCHA Nigeria COD-AB administrative boundaries | `nga_admin_boundaries.xlsx` + `.geojson/` | current | CC BY-IGO |
...
| 08 | **OCHA JIAF Nigeria 2026 — Education sector PiN & Severity** | `jiaf_nigeria_2026.xlsx` | 2026 HNO | Open with citation |

All eight sources were retrieved during late April / early May 2026. The
exact files used to compute the published map are stored under `data/raw/`
in this repository.

Source 03 (iMMAP) was originally the third indicator but contained a
state-wide data ceiling for Adamawa (0 closures recorded across all 21
...
context but do not drive the composite score. See `adamawa_decision.md`.
